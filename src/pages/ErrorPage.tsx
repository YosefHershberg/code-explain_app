...
const ErrorPage = ({ resetErrorBoundary, resetFunction, status, message }: React.ComponentType<FallbackProps> | any) => {
    return (
        <div className="h-screen w-screen flex flex-col justify-center items-center bg-slate-300 dark:bg-slate-700">
            <h1 className='text-red-600 text-xl text-center px-1'>{message ? message : 'Something went terribly wrong!'}</h1>
